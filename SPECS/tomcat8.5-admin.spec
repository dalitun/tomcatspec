...
%{__rm} -rf %{buildroot}/%{tomcat_user_home}/webapps/examples
%{__rm} -rf %{buildroot}/%{tomcat_user_home}/webapps/ROOT
...
%dir %{tomcat_user_home}/webapps/host-manager
%dir %{tomcat_user_home}/webapps/manager
...
Thank you for using tomcat8.5-admin!
